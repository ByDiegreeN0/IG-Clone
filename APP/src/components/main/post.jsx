        ...
        <div className="post-header">
          <div className="post-user">
            ...
            <div className="user-data">
              <strong>
                <a href="" className="user-data-tittle">
                  <p>Nombre</p>
                </a>
              </strong>
              <p className="user-data-p">Datos adicionales</p>
            </div>
          </div>
        ...
        <div className="post-footer">
          ...
          <div className="post-footer-bottom">
            ...
            <p>
              ...
              architecto, debitis incidunt excepturi pariatur porro at earum
              deleniti, magni aliquam fugit autem. Vero, delectus odit?
            </p>
            <a href="">
              <button className="footer-top-btn post-link">Ver Comentarios</button>
            </a>
            <span className="post-span">Hace 3 dias</span>
          </div>
        </div>
      </div>
    </div>
